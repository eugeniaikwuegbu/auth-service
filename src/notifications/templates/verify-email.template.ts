export const verificationEmailHtml = (userName, verificationLink) => {
  return ` 
    ...
    .0" />
      ...
      <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;60=
          ...
          <table width="100%" style="
            ...
            <tr>
              <td style="padding: 50px 16px 20px">
                <table width="100%" style="border-spacing: 0; max-width: 512px; margin: 0 auto">
                  <tr>
                    <td style="padding: 0">
                      <a rel="nofollow noopener noreferrer">
                        <img src="https://res.cloudinary.com/dkhqzhiqh/image/upload/v1715187874/lexauto/logo_efrqge.svg"
                          alt="lexauto logo" width="40" title="lexauto" style="border: 0" />
                      </a>
                    </td>
                  </tr>
                </table>
                  ...
                  <tr>
                    <td style="padding: 0">
                      ...
                      <p style="
                        ...
                        <br />
                        <br />
                        Thank you for creating your account on Lexauto. To
                        activate your account and unlock all the amazing features
                        Lexauto has to offer, simply click the verification button
                        below:
                        <br />
                        <br />
                      </p>
            ...
            <tr>
              <td style="padding: 0 16px 32px">
                <table width="100%" style="border-spacing: 0; max-width: 512px; margin: 0 auto">
                  <tr>
                    <td style="padding: 0">
                      <a rel="nofollow noopener noreferrer" target="_blank" href="${verificationLink}" style="
                            display: block;
                  ...
                  <tr>
                    <td style="padding: 0">
                      <p style="margin: 0; padding: 0">
                        <span style="font-weight: bold; font-style: italic">Don't wait any longer!
                        </span>
                        Verify your account today and start experiencing the
                        Lexauto advantage.
                      </p>
                      <br />
                      <p style="margin: 0; padding: 0">
                        ...
                        <a rel="nofollow noopener noreferrer" ymailto="mailto:support@lexauto.ai" target="_blank"
                          href="mailto:support@lexauto.ai" style="text-decoration: none; color: #3657c4">
                          support@lexauto.ai
                        </a>
                    ...
                    <td style="padding: 0">
                      ...
                      <center style="max-width: 512px; margin: 0 auto">
                        <a rel="nofollow noopener noreferrer" target="_blank" href=""
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="#526581" fill="none" width="24"
                            style="border: 0">
                            <path
                        ...
                        <a rel="nofollow noopener noreferrer" target="_blank" href=""
                          style="padding-right: 28.8px; color: transparent">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" color="#526581" fill="none"
                            style="border: 0">
                            <path
                        ...
                        <a rel="nofollow noopener noreferrer" target="_blank" href=""
                          style="padding-right: 28.8px; color: transparent">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#526581"
                            fill="none" style="border: 0">
                            <path
                        ...
                        <a rel="nofollow noopener noreferrer" ymailto="mailto:support@lexauto.ai" target="_blank"
                          href="mailto:support@lexauto.ai" style="color: transparent">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#526581"
                            fill="none" style="border: 0">
